...
import static com.ucsc.rwpham.tourbeta.R.id.map;
import static com.ucsc.rwpham.tourbeta.R.string.be105Desciption;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    //Tracy asked to show a toast so people aren't confused
    //about needing to swipe up to see more info.
    // Boolean makes it so it only happens once.
    private boolean pinTappedAlready = false;
    ...
    public void initializeChosenMajorsToDisplay() {
        ...
        for(int i = 0; i < majorArray.length; i++) {
            ...
            if(majorsToDisplay.contains(major)) {
                ...
                if(major.equals("Graduate Division")) {
                    Context context = getApplicationContext();
                    CharSequence text = "Please zoom out to see Graduate Division points of interest";
    ...
    public boolean onMarkerClick(final Marker marker) {
        ...
        String imageFilePath = "com.ucsc.rwpham.tourbeta:drawable/" + imageFileName;
...
public void showSwipeUpToast() {
    if(!pinTappedAlready) {
        Context context = getApplicationContext();
        CharSequence text = "Swipe up to see more information";
        int duration = Toast.LENGTH_SHORT;
        Toast toast = Toast.makeText(context, text, duration);
        toast.show();
        pinTappedAlready = true;
    }
}
 ...
 */
            ...
            myDB.execSQL("INSERT INTO "
                    ...
                    "'defaultimage'," + opticsLabDescription + ", '37.000495', '-122.062870');");

            myDB.execSQL("INSERT INTO "
                    + TableName
                    + " (id, title, location, major, image, description, latitude, longitude)"
                    + " VALUES (9,'DANSER Lab', 'Baskin Engineering 2 Room 308', 'Electrical Engineering', " +
                    "'danser'," + danserDescription + ", '37.000929', '-122.063308');");
            ...
            myDB.execSQL("INSERT INTO "
                    + TableName
                    + " (id, title, location, major, image, description, latitude, longitude)"
                    + " VALUES (13,'Computer Vision Lab', 'Baskin Engineering 2 Room 209', 'Computer Science', " +
